...
import com.example.techstore.dto.response.PageResponse;
import com.example.techstore.dto.response.UserDetailDto;
import com.example.techstore.dto.response.UserResponseDto;
...
public class AdminServiceImpl implements AdminService{
    ...
    if (request.getIsActive() != true && request.getIsActive() != false) {
