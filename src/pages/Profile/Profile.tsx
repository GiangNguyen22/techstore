        ...
        <div className="mb-8">
            ...
            {token && isAdmin && (
              ...
              <button
                ...
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2 rounded shadow transition"
              >
                <span className="text-2xl">📨</span>
                <span>Vào trang Chat Admin</span>
              </button>
            )}
        </div>
