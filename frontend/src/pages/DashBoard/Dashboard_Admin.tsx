...
const [activeMenu, setActiveMenu] = useState('Dashboard_Admin');
  ...
  const transactions = [
    { id: '#6545', customerId: '#6545', date: '01 Oct 11:29 am', status: 'Paid', amount: '$64', statusColor: 'text-green-600' },
          ...
          <div className="mb-6">
            ...
            <div className="space-y-1">
              {productMenuItems.map((item, index) => (
                <MenuItem key={index} icon={item.icon} label={item.label} badge={item.badge} />
              ))}
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto h-full">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-xs text-gray-400 mb-4">Previous 7days ($235)</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <span className="bg-red-500 text-white text-xs px-2 py-1 rounded">187.23</span>
                </div>
                <MoreHorizontal className="text-gray-400" size={20} />
              </div>
              <div className="mb-4">
              ...
              <p className="text-xs text-gray-400 mb-4">Previous 7days (7.6k)</p>
              <button className="w-full py-2 border border-gray-200 rounded-lg text-sm text-gray-600">Details</button>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="flex items-end gap-1 h-16 mb-4">
                  {[20, 35, 25, 40, 30, 45, 35, 50, 25, 40, 30, 55, 40, 35, 45, 30, 50, 35, 25, 40].map((height, i) => (
                  ...
                  <tbody>
                    {transactions.map((transaction, index) => (
                      <tr key={index} className="border-b">
                        ...
                        <td className="py-3">
                          <span className={`inline-flex items-center gap-1 text-sm ${transaction.statusColor}`}>
                            <div className={`w-2 h-2 rounded-full ${transaction.status === 'Paid' ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
                            {transaction.status}
                          </span>
                        </td>
